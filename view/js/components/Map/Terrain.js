...
export class Terrain extends Map {
        ...
        tiles.forEach(({ x, y }) => {
            ...
            if (tile.isLand) {
                ...
                if (tile.isCoast) {
                    ...
                    // going clockwise
                    bitmask = (this.world().getNeighbour(tile, 'w').isLand ? 1 : 0) |
                    ...
                    if (bitmask > 0) {
                        ...
                        const image = e('canvas[height="16"][width="16"]'), imageContext = image.getContext('2d');
