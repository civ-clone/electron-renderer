...
var _Cities_showNames, _Cities_showSize;
import { Map } from '../Map.js';
export class Cities extends Map {
    constructor() {
        super(...arguments);
        _Cities_showNames.set(this, true);
        _Cities_showSize.set(this, true);
    }
    ...
    setShowSize(showSize) {
        __classPrivateFieldSet(this, _Cities_showSize, showSize, "f");
    }
    setShowNames(showNames) {
        __classPrivateFieldSet(this, _Cities_showNames, showNames, "f");
    }
}
_Cities_showNames = new WeakMap(), _Cities_showSize = new WeakMap();
